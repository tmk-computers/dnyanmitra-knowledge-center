...
3. **No Mismatched Paths**: All referenced document URLs must point to existing files inside the workspace using relative paths and forward slashes. Do not invent files.
4. **Style Guide Compliance**: You must strictly apply the spelling, date, time, and currency formatting rules defined in [DASP-STYLE-Writing-Mechanics-v1.0.md](../../content-standards/22-Style-Guide/DASP-STYLE-Writing-Mechanics-v1.0.md).
...
Check 6: Are all file links formatted as relative paths without backticks?
```
